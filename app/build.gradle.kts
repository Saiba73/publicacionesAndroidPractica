...
dependencies {
    ...
    val version_retroftit = "2.9.0"
    implementation("com.squareup.retrofit2:retrofit_${version_retroftit}")
    implementation("com.squareup.retrofit2:converter-gson:${version_retroftit}")
